========================================================================
    APLICACIÓN: testlerelelfor Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación testlerelelfor.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación testlerelelfor.

testlerelelfor.vcxproj
...
testlerelelfor.vcxproj.filters
